...
def test_collect_status_skips_mesh_when_unsupported():
    ...
    result = collect_status(
        RouterWithoutMesh(), None, None, None, None, None, None, logging.getLogger("test")
    )
...
def test_collect_status_fetches_mesh_when_supported():
    ...
    assert result[8][0].name == "Living Room"
...
def test_mesh_device_info_falls_back_to_mac_without_name():
